...
import static com.zerogift.batch.core.entity.email.QEmailMessage.emailMessage;
import static com.zerogift.batch.job.constant.JobConstant.STATISTIC_EMAIL_SEND_JOB;
...
public class StatisticEmailSendConfig {
    ...
    @JobScope
    @Bean
    public Step statisticEmailSendStep(QuerydslNoOffsetPagingItemReader<EmailMessage> statisticEmailSendStepItemReader,
