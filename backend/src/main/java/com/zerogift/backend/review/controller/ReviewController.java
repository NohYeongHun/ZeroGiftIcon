...
public class ReviewController {
    ...
    public ResponseEntity<?> addReview(@RequestHeader LoginInfo loginInfo,
    ...
    public ResponseEntity<?> modifyReview(@RequestHeader LoginInfo loginInfo,
    ...
    public ResponseEntity<?> removeReview(@RequestHeader LoginInfo loginInfo,
                                          @PathVariable Long reviewId) {
    ...
    public ResponseEntity<?> userReviewList(@RequestHeader LoginInfo loginInfo) {
